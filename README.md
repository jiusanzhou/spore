...
**📊 SWE-bench Lite dev: 12 / 23 resolved (52.2%)** — measured by the official Docker harness ([details](bench/swe-bench/README.md)). Single-shot patch generation through the ACP runtime + plan-execute-verify loop; no swarm involvement.
